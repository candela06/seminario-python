...
1. Copiar con el comando ```git clone <link>``` el enlace del poyecto y acceder a la carpeta grupo08.
...
```bash
git clone git@gitlab.catedras.linti.unlp.edu.ar:python2024/code/grupo08.git 
cd grupo08  
python3 -m venv venv  
